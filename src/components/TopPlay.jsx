...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePlayClick, handlePauseClick }) => (
  ...
  py-2 p-4 rounded-lg cursor-pointer mb-2'>
    ...
    <div className='flex-1 flex flex-rowjustify-between items-center'>
      <img className='w-[50px] h-[50px] rounded-lg' src={song?.images?.coverart} 
      alt={song?.title} />
...
const TopPlay = () => {
  ...
  return (
    ...
    xl:max-w-[400px] max-w-full flex flex-col'>
